...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    PMAKESQAUREFUNCTION pMakeSquare = NULL;
    int num1, num2;
    TCHAR str[255];
...
pMakeSquare = (PMAKESQAUREFUNCTION)GetProcAddress(hLib, "MakeSquare");
if (pMakeSquare == NULL)
{
MessageBox(hwnd, TEXT("Make sqaure function address cannot be obtained"), TEXT("Error"), MB_OK);
DestroyWindow(hwnd);
}
num1 = 15;
num2 = pMakeSquare(num1);
wsprintf(str, TEXT("Sqaure of %d is %d"), num1, num2);

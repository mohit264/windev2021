//csc /t:winexe /resource:Merc.ico  CSharpWindow.cs
//rc Window.rc
//csc /t:winexe /resource:Merc.ico /win32res:Window.res  CSharpWindow.cs
...
public class CSharpWindow : Form
{
    public CSharpWindow()
    {
        //code
        //caption of window
        Icon = new Icon(GetType().Assembly.GetManifestResourceStream("Merc.ico"));
        Text = "C# Window";
        Width = 800;
        Height = 600;

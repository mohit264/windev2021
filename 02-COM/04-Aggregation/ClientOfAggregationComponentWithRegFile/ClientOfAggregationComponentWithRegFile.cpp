...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (iMsg)
    {
        case WM_CREATE:
            ...
            hr = pIMultiplication->MultiplicationOfTwoIntegers(num1, num2, &iMultiplication);
            wsprintf(str, TEXT("Multiplication Of %d and %d is %d"), num1, num2, iMultiplication);
            ...
            hr = pIDivision->DivisionOfTwoIntegers(num1, num2, &iDivision);
            wsprintf(str, TEXT("Division Of %d and %d is %d"), num1, num2, iDivision);

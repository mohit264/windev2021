...
IUnknown *gpInUnknownFromSum = NULL;
IUnknown *gpInUnknownFromSubtract = NULL;
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (iMsg)
    {
        case WM_CREATE:
            ...
            hr = pISum->QueryInterface(IID_IUnknown, (void **) &gpInUnknownFromSum);
            hr = pISubtract->QueryInterface(IID_IUnknown, (void **) &gpInUnknownFromSubtract);

            if (gpInUnknownFromSum == gpInUnknownFromSubtract)
            {
                MessageBox(hwnd, TEXT("Equal"), TEXT("Yes"),MB_OK);
            }
